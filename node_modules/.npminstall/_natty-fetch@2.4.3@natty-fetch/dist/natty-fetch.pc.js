/*! natty-fetch.pc.js v2.4.3 | MIT License | fushan | https://github.com/jias/natty-fetch */
...
API.prototype.send = function send (vars) {
    ...
    request.send({
        ...
        onError: function (error) {
            defer.reject(error);
            event.fire('g.reject', [error, config$$1]);
            event.fire(this$1.contextId + '.reject', [error, config$$1]);
        },
        onComplete: function () {
            var indexToRemove;
            for (var i=0, l=this$1._pendingList.length; i<l; i++) {
